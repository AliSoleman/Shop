defmodule ShopWeb.ConnCase do
  ...
  def register_and_log_in_customer(%{conn: conn} = context) do
    customer = Shop.CustomersFixtures.customer_fixture()
    scope = Shop.Customers.Scope.for_customer(customer)
  ...
  def log_in_customer(conn, customer, opts \\ []) do
    token = Shop.Customers.generate_customer_session_token(customer)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Shop.CustomersFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
