defmodule Shop.Customers do
  ...
  alias Shop.Customers.{Customer, CustomerToken, CustomerNotifier}
  ...
  See `Shop.Customers.Customer.email_changeset/3` for a list of supported options.
  ...
  See `Shop.Customers.Customer.password_changeset/3` for a list of supported options.
