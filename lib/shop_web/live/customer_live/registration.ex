defmodule ShopWeb.CustomerLive.Registration do
  ...
  def mount(_params, _session, %{assigns: %{current_scope: %{customer: customer}}} = socket)
    ...
    {:ok, redirect(socket, to: ShopWeb.CustomerAuth.signed_in_path(socket))}
  end
  ...
  def handle_event("validate", %{"customer" => customer_params}, socket) do
    changeset = Customers.change_customer_email(%Customer{}, customer_params, validate_unique: false)
